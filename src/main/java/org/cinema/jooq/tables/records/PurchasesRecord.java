...
public class PurchasesRecord extends UpdatableRecordImpl<PurchasesRecord> implements Record7<Long, byte[], byte[], byte[], Integer, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row7<Long, byte[], byte[], byte[], Integer, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public PurchasesRecord values(Long value1, byte[] value2, byte[] value3, byte[] value4, Integer value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PurchasesRecord(Long id, byte[] uuid, byte[] userUuid, byte[] moviePublicUuid, Integer quantityOfTickets, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Purchases.PURCHASES);
